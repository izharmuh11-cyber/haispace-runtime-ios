...
enum KeychainKey: String {
    ...
    case apiKey             = "id.haispaceproject.booth.api_key"
    case boothId            = "id.haispaceproject.booth.booth_id"
...
struct KeychainHelper {
    ...
    // MARK: - Convenience: API Key & Booth ID
    ...
    @discardableResult
    static func saveBoothId(_ id: String) -> Bool {
        save(id, for: .boothId)
    }

    static func getBoothId() -> String? {
        read(for: .boothId)
    }
